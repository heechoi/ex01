<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <script src="${pageContext.request.contextPath }/resources/board/js/read.js?v=2" type="text/javascript"></script>
				...
				<div class="box">
					...
					<div class="box-body">
						<form method="get" action="" id="f">
							<input type="hidden" name="bno" value="${boardVO.bno }" id="hidden">
						</form>
